...
<body class ='bglight'>
<table width="75%" border="0" cellspacing="0" cellpadding="5" class="main">
  <tr> 
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr> 
        <td width="5em" valign="top"><?php 
/*********************** MYACCOUNT MENU ****************************
	...
	if(!empty($err))  {
      ...
      <form action="mysettings.php" method="post" name="myform" id="myform">
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" class="forms">
          <tr> 
            <td colspan="2"> Your Name / Company Name<br> <input name="name" type="text" id="name"  class="required" value="" size="50"> 
          ...
          <tr> 
            <td colspan="2">Address <span class="example">(full address with ZIP)</span><br> 
              <textarea name="address" cols="40" rows="4" class="required" id="address"></textarea> 
            </td>
          </tr>
          <tr> 
            <td>Country</td>
          ...
          <tr> 
            ...
            <td width="73%"><input name="tel" type="text" id="tel" class="required" value=""></td>
          </tr>
          <tr> 
            <td>Fax</td>
          ...
          <tr> 
            <td>Website</td>
            <td><input name="web" type="text" id="web" class="optional defaultInvalid url" value=""> 
          ...
          <tr> 
            <td>User Name</td>
            <td><input name="user_name" type="text" id="web2" value="" disabled></td>
          </tr>
          <tr> 
            <td>Email</td>
            <td><input name="user_email" type="text" id="web3"  value="" disabled></td>
          </tr>
        </table>
        <p align="center"> 
