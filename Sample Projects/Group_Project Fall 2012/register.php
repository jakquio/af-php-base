...
****************************************************************/
 require_once('recaptchalib.php');
      $privatekey = "6LdnFdcSAAAAAH-4sNv01uGcJt69n-5HUqjgc_cJ";
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="main">
 ...
 var RecaptchaOptions = {
  ...
  <script type="text/javascript"
     src="http://www.google.com/recaptcha/api/challenge?k=6LdnFdcSAAAAALJUrxeQL5RBIxx5Dyni9EHsriXR">
  </script>
  <noscript>
     <iframe src="http://www.google.com/recaptcha/api/noscript?k=6LdnFdcSAAAAALJUrxeQL5RBIxx5Dyni9EHsriXR"
	...
	<form action='index.html' method ='post'>
	  	<p align='center'>
			<input type='submit' name='logout' value='Return to Main'>
		</p>
	</form>
